...
const toolConfig: Record<string, { icon: string; color: string; bgColor: string }> = {
  exec: { icon: '⚡', color: 'text-yellow-700', bgColor: 'bg-yellow-50 border-yellow-300' },
  read: { icon: '📖', color: 'text-blue-700', bgColor: 'bg-blue-50 border-blue-300' },
  write: { icon: '✏️', color: 'text-green-700', bgColor: 'bg-green-50 border-green-300' },
  process: { icon: '⚙️', color: 'text-purple-700', bgColor: 'bg-purple-50 border-purple-300' },
  message: { icon: '💬', color: 'text-indigo-700', bgColor: 'bg-indigo-50 border-indigo-300' },
  default: { icon: '🔧', color: 'text-slate-700', bgColor: 'bg-slate-50 border-slate-300' },
};
